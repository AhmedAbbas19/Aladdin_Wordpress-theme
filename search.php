...
<ul class="breadcrumb">
  ...
  <li class="active"><?php echo 'Search: ' . esc_html(get_search_query()); ?></li>
</ul>
...
<div class="categories">
    <div class="container-fluid">
        ...
        <?php 
            ...
            if (have_posts()) {
                echo '<div class="grid-area-info">' .
                        '<h2 class="heading">Get Search Results For: "' . esc_html(get_search_query()) . '"</h2>' .
                        '</div>';
                while (have_posts()) { the_post();
                    $aladdin_page_posts[] = get_the_ID();
                    get_template_part( 'templates/content-search-result');
                }
                ...
                get_template_part( 'templates/content-noresult');
            }
        ?>
        </div>
